package ma.emsi.customerfrontthymleafapp.sec;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .csrf(cs -> cs.ignoringRequestMatchers("/h2-console/**"))
    ...
    private OidcClientInitiatedLogoutSuccessHandler oidLogoutSuccessHandler() {
